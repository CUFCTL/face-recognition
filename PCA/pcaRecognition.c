...
/* How to run this program
	- ./pcaRecognition names_of_test_set.txt(or .dat)
	- names_of_test_set.dat is autogenerated by pcaCreateDatabase and is called filenamesDB.dat or
	  you can customize it and make your own .txt or .dat file 
	- output will give the closest match it can find
*/
...
int main (int argc, char **argv) {
	...
	int i, j;
	char testPath[] = "..//test_images//"; // this is the path to the iamges folder... we can make this variable
